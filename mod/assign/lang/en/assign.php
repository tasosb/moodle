...
$string['downloadgrouponce'] = 'Download group submissions in one file/folder';
$string['downloadgrouponce_help'] = 'If enabled, group submissions will be downloaded as a single submission.';
...
$string['privacy:metadata:assigndownloadgrouponce'] = 'A user preference for whether groups submissions should be donwloaded as a single submission.';
