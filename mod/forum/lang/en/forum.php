...
$string['digestmailheader'] = 'This is your daily digest of new posts from the {$a->sitefullname} forums. To change your default forum email preferences, go to {$a->userprefs}.';
...
$string['digestmailsubject'] = '{$a->siteshortname}: Forum digest';
